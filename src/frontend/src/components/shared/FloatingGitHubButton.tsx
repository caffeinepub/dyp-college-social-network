          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <a
                ...
                className="w-14 h-14 rounded-2xl flex items-center justify-center shadow-bubble-lg transition-all duration-300 hover:scale-110 hover:shadow-bubble-lg animate-float"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="w-14 h-14 rounded-2xl flex items-center justify-center shadow-bubble-lg transition-all duration-300 hover:scale-110 hover:shadow-bubble-lg animate-float relative"
                style={{ background: "var(--gradient-primary)" }}
